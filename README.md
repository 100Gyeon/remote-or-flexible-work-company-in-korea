...
| [카카오헬스케어](#카카오헬스케어) | O (08:00 ~ 10:00 사이 자율 출퇴근) | X | [홈페이지](https://kakaohealthcare.com) / [채용공고](https://recruit.kakaohealthcare.com/recruit) |
...
**1. 크루들이 더 몰입할 수 있는 환경을 제공합니다.**

- 최신 IT 장비, 모션데스크 & 허먼밀러 의자 제공
- 판교역 초역세권! 쾌적한 카카오판교아지트에 위치
- 건강하고 맛있는 메뉴로 가득한 사내식당 운영
- 야근한 만큼 쉴 수 있는 보상휴가 제도 (비포괄임금)
- 1시간 단위로 쪼개서 사용할 수 있는 연차휴가
- 8시 ~ 10시까지 출근할 수 있는 시차출퇴근제

**2. 안정된 생활 속에 크루들이 개인의 성장을 추구할 수 있도록 지원합니다.**

- 가족들의 단체 상해보험 지원 (본인, 배우자, 양가 부모님, 자녀 모두)
- 매년 정밀 건강검진 수검 지원
- 현금처럼 활용할 수 있는 베네핏 카드(연 180만원) 지원
- 매월 식비(20만원) 지원
- 카카오 공동체 직장 어린이집 지원
- 직무 관련 교육비 및 도서 구매비 지원
